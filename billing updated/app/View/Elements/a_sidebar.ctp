...
<ul class="nav nav-sidebar">
        ...
        array('class' => 'color_black navlink', 'escape' => false)
             ...
             <li class="dropdown <?php echo ($params=='medList' || $params=='addMedicine'?'active':''); ?>">
			    ...
			    <li class="dropdown <?php echo ($params=='dealList' || $params=='addDealer'?'active':''); ?>">
                 <a class="dropdown-toggle color_black" data-toggle="dropdown" href="#"><i class="fa fa-user-plus"></i> <strong>Dealer</strong>
                <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li> <?php echo $this->Html->link('<i class="fa fa-list-ol"></i> Dealer List','/dealList',
                        array(
                                    'class'=>'color_black navlink',
                                    'full_base' => true, 'escape' => false
                       )
            ); ?></li>
                  <li> <?php echo $this->Html->link('<i class="fa fa-plus-square"></i> Add Dealer','/addDeal',
                array(
                            'class'=>'color_black navlink',
                            'full_base' => true, 'escape' => false
               )
