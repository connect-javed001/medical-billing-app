		...
		<div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="row">
                            <div class="col-md-12">
                                 <div class="form-group">
                          <label for="inputEmail3" class="col-md-4 col-sm-4 control-label">Select Dealer</label>
                          <div class="col-md-8 col-sm-8">
                             <?php
                                                   echo $this->Form->input('dealer_id',array('type'=>'select','label' => FALSE,
                                                       'class'=>'form-control ','id'=>'dlist','required'=>TRUE,'options'=>$dlist));
                                                  ?>
                          </div>
                        </div>
                            </div>
